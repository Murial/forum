        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Data</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#projects">Input</a></li>
